...
namespace ShopOnline.Api.Controllers
{
    ...
    public class ShoppingCartController : CoreController
    {
        ...
        public async Task<ActionResult<IEnumerable<CartItemDto>>> GetItems(int userId)
        {
            try
            {
                ...
                if (products is null) throw new Exception("No product exist in the system");
        ...
        public async Task<ActionResult<CartItemDto>> PostItem([FromBody] CartItemtoAddDto cartItemToAddDto)
        {
            try
            {
                ...
                if (product is null) throw new Exception($"Something went wrong when attempting " +
                    $"to retrieve product (productId:({cartItemToAddDto.ProductId})");
